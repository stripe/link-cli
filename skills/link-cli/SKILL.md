...
- For summaries, transactions, balances, and sources, use the `financial-insights` skill. Its `summaries list` guidance explains how agents can retrieve precomputed financial insights about consumer preferences, which may help with identifying the right business to make a purchase at.
