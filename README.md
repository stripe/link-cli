...
**Test mode:** Pass `--test` to create testmode credentials (uses test card `4000009990001984`), useful for development and integration testing without real payment methods.
